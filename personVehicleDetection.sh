...
./object_detection_sample_ssd -i ~/majorProject/images/pedVehicle.jpg -m ~/majorProject/Models/person-vehicle-bike-detection-crossroad-0078.xml ./lib/ async -d MYRIAD
