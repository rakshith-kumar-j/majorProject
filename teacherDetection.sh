...
./object_detection_sample_ssd -i ~/majorProject/images/teacher.jpg -m ~/majorProject/Models/person-detection-action-recognition-teacher-0002.xml ./lib/ async -d MYRIAD
